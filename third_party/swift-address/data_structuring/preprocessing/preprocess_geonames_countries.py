...
from data_structuring.preprocessing.preprocess_utils import (
...
if __name__ == "__main__":
    ...
    df_geonames_countries = get_country_data(
    ...
    df_countries = (
        ...
        df_geonames_countries.select(pl.all().exclude("Languages"))
    ...
    df_countries_divisions = (
        ...
        .with_columns(
            ...
            cc_list=pl.col("country code")
            .list.concat(pl.col("cc2").fill_null("").str.split(","))
            .list.unique()
