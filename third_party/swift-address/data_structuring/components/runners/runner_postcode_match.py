...
class RunnerPostcodeMatch(BaseRunner):
    ...
    def match(self, data: list[str]) -> Generator[ResultRunnerPostcodeMatch, None, None]:
        ...
        almost_all_postcodes_match = partial(
            post_code_match.find_postcode_town_matches,
            postcodes_dict=self.database.full_dict,
            regex_list=self.database.full_regex_list,
        )

        argentinian_postcodes_match = partial(
            post_code_match.find_postcode_town_matches,
        ...
        brazilian_postcodes_match = partial(
            post_code_match.find_postcode_town_matches,
        ...
        chilean_postcodes_match = partial(
            post_code_match.find_postcode_town_matches,
        ...
        chinese_postcodes_match = partial(
            post_code_match.find_postcode_town_matches,
        ...
        maltese_postcodes_match = partial(
            post_code_match.find_postcode_town_matches,
